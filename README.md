...
I installed various libraries, that included the following: See file [card heart _file](https://github.com/mueeze/Group14/blob/Jared-Murray/Credit_card_fraud.ipynb)
